<template>
    <article class="video-wrapper" v-scroll="loadingMore">
        ...
        <NoneData v-show="videoEnd"></NoneData>
    </article>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    drawVideo() {
      ...
      video.play();
      //每33.3333333s,代码就会绘制视频的当前帧
      let fps = 1000 / 30,
        w = document.querySelectorAll(".video")[index].clientWidth || 320,
        h = document.querySelectorAll(".video")[index].clientHeight || 176;
      video.addListener("play", () => {
        setInterval(() => {
  ...
  computed: {
    ...mapGetters(["videoList", "videoLoading", "videoEnd"])
  }
};
</script>
